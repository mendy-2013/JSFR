...
from backbone import resnet50_fpn_u_backbone
...
def main(parser_data):
    ...
    backbone = resnet50_fpn_u_backbone(norm_layer=torch.nn.BatchNorm2d)
    ...
    model.eval()
    with torch.no_grad():
        for image, targets, ground in tqdm(val_dataset_loader, desc="validation..."):
            # 将图片传入指定设备device
...
if __name__ == "__main__":
    ...
    # 训练好的权重文件
    parser.add_argument('--weights', default='./save_weights/resUNetFpn-model-50.pth', type=str, help='training weights')
